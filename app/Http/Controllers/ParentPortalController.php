...
class ParentPortalController extends Controller
{
    ...
    public function viewChild(Student $student)
    {
        ...
        if (!$parent->students()->where('students.student_id', $student->student_id)->exists()) {
